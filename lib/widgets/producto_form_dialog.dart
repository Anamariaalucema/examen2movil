...
class ProductoFormResult {
  ...
  //guardar nombre, categoria y stock para editar el producto
...
class _InventarioFormDialogState extends State<InventarioFormDialog> {
  ...
  //pre-llenar los campos con los datos actuales del producto
  @override
  void initState() {
    super.initState();
    if (widget.inventario != null) {
      _nombreController.text = widget.inventario!.nombreProducto;
      _stockController.text = widget.inventario!.stock.toString();
      _categoriaSeleccionada = widget.inventario!.categoria;
    }
  }
